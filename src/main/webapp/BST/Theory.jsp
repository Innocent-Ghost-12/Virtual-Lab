...
<a href="Aim.jsp" class="p-2">	
  ...
  <a href="Posttest.jsp" class="p-2">	
    ...
    <P>
          ...
          BST is a collection of nodes arranged in a way where they maintain BST properties. Each node has a key and an associated value. <br>While searching, the desired key is compared to the keys in BST and if found, the associated value is retrieved.
          <br>
          <br>
        ...
        <li> Pre-order Traversal − Traverses a tree in a pre-order manner. </li>
        <li> In-order Traversal − Traverses a tree in an in-order manner. </li>
        <li> Post-order Traversal − Traverses a tree in a post-order manner. </li>
