...
<h4 class="alert-heading">Node</h4>
<p>struct node {<br>
&nbsp;&nbsp; int data;   <br>
...
<br>
      ...
      <div class="alert alert-secondary" role="alert">
<h4 class="alert-heading">Search Operation</h4>
<p>struct node* search(int data){ {<br>
&nbsp;&nbsp; struct node *current = root;   <br>
&nbsp;&nbsp; printf("Visiting elements: ");<br><br>
&nbsp;&nbsp; while(current->data != data){<br><br>
&nbsp;&nbsp; &nbsp;  &nbsp;if(current != NULL) {<br>
