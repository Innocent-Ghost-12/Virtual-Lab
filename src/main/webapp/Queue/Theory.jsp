...
<br>
           The elements in a queue are added at one end called the REAR and removed from the other end
called the FRONT.
<br>
          ...
          <br>
<br>
         The main function that has to be included in queue are:
        <ol>
             <li>
             Insert(Q, val) – Insert new element at the end of the queue. </li>
              <li>  Remove (Q)- Removes element from the front of the queue. </li>
              <li>  isEmpty(Q)- returns true if queue is empty else returns false </li>
              <li>  IsFull(Q)- returns true if queue is full else returns false
             </li>
         </ol>
