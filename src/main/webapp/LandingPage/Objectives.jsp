<!DOCTYPE html><html lang="en"><head>
  ...
  <body class="p-0 container-fluid vlabs-page d-flex flex-column justify-content-between">
	...
	<div class="nav flex-column sidebar nav-menu flex-shrink-0" id="menu">  <a href="Introduction.jsp" class="p-2">	
    Introduction	
  </a>
  <a href="Objectives.jsp" class="p-2">	
    Objective	
  </a>
  <a href="ListofExperiments.jsp" class="p-2">	
    List of experiments	
  </a>
  <a href="Reference.jsp" class="p-2">	
    References	
  </a>
  <a href="CourseAlignment.jsp" class="p-2">	
    Course Alignment	
  </a>
  <a href="Feedback.jsp" class="p-2">	
    Feedback	
  </a>
</div>
	<div class="vlabs-page-content px-4 pb-4 flex-grow-1">
	  <span class="lab-name"><h2 class="text-center">Data Structures</h2></span><!--labname-->
	  <div><div>
<p></p>
<ul>
<li>To impart the basic concepts of data structures and algorithms.</li>
<li>To understand concepts about searching and sorting techniques.</li>
<li>To Understand basic concepts about stacks,queues,lists,trees and graphs.</li>
<li>To understanding about writing algorithms and step by step approach in solving problems with the
help of fundamental data structures.</li>
