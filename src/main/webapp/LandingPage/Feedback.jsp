...
<a id="feedback-btn-link" href="sortvisualiser.zip" download="sortvisualiser.zip" target="_blank"><button id="feedback-btn" type="button" class="btn btn-default btn-lg">Share Your Experience</button></a>
<br><br>
